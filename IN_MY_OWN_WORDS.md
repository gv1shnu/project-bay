...
No trust in the challengers (they want money), and we don't want to spam random users unless we have to.
I intend to use a hybrid jury duty model for this phase.

### Level 1: The Trust Check
• A uploads proof.
• B & C get a ping. They have 24 hours to review. Status: Pending.
